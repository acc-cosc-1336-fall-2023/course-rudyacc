import unittest
from tests.examples.c_decisions import get_letter_grade, is_overtime
from tests.examples.c_decisions import is_vowel
from tests.examples.c_decisions import get_and_result, get_notted_value, get_or_result, is_even, is_odd
