...
from src.examples.a_example.devprocess import add_numbers, get_remainder, integer_division, operator_precedence_1, operator_precedence_2, square_value
...
class Test_Config(unittest.TestCase):
    ...
    def test_integer_division_2(self):
        self.assertEqual(2, integer_division(20, 8))
